    ...
    <section style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          در دنیای امروز، مدیریت کارآمد و هوشمندانه نیاز به ابزارهایی دارد که بتوانند تمام جوانب کسب‌وکار را پوشش دهند. با اکسیژن، ما اطمینان می‌دهیم که سازمان‌ها با تکیه بر داده‌های دقیق و فرآیندهای یکپارچه، بهره‌وری خود را به حداکثر برسانند و مسیر رشد را با سرعت و دقت طی کنند.
          </p>
        </div>
        ...
        <div style={{
          ...
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M31.82 24.7399H41.2C41.04 34.0799 39.2 35.6199 33.46 39.0199C32.8 39.4199 32.58 40.2598 32.98 40.9398C33.38 41.5998 34.22 41.8199 34.9 41.4199C41.66 37.4199 44.02 34.9798 44.02 23.3398V12.5599C44.02 9.13994 41.24 6.37988 37.84 6.37988H31.84C28.32 6.37988 25.66 9.03994 25.66 12.5599V18.5599C25.64 22.0799 28.3 24.7399 31.82 24.7399Z" fill="#E4E4E7"/>
          <path opacity="0.4" d="M10.1799 24.7399H19.5599C19.3999 34.0799 17.5599 35.6199 11.8199 39.0199C11.1599 39.4199 10.9399 40.2598 11.3399 40.9398C11.7399 41.5998 12.5799 41.8199 13.2599 41.4199C20.0199 37.4199 22.3799 34.9798 22.3799 23.3398V12.5599C22.3799 9.13994 19.5999 6.37988 16.1999 6.37988H10.1999C6.67989 6.37988 4.01989 9.03994 4.01989 12.5599V18.5599C3.99989 22.0799 6.65989 24.7399 10.1799 24.7399Z" fill="#E4E4E7"/>
          </svg>
