...
const SolutionSlide = ({ solution, isActive, direction = 'next' }: SolutionSlideProps) => {
        ...
        <div className="slide-top-section">
          ...
          <button className="read-more-btn">
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.99998 13.2802L5.65331 8.93355C5.13998 8.42021 5.13998 7.58022 5.65331 7.06688L9.99998 2.72021" stroke="#FAFAFA" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        </div>
