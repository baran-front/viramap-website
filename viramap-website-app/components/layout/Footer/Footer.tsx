          ...
          <div className="lg:w-2/5">
            ...
            <div className="flex items-center gap-2 mb-8">
              ...
              >
                <path
                  ...
                  fill="url(#paint0_linear_8046_1275)"
                />
                <path
                  ...
                  fill="url(#paint1_linear_8046_1275)"
                />
                <path
                  d="M32.434 10.0847C29.2874 18.2851 22.0407 32.7784 18.4174 39.9295C19.0531 40.5015 20.8965 41.3023 22.0407 39.9295C23.471 38.2134 37.3922 17.0454 39.1085 10.2755C39.5102 8.69122 36.765 1.31256 34.4363 1.3125C33.2921 1.31247 32.0526 2.11746 31.1944 2.64744C32.9107 1.58748 35.5096 4.26835 32.434 10.0847Z"
                  fill="url(#paint2_linear_8046_1275)"
                />
                <path
                  ...
                  fill="url(#paint3_linear_8046_1275)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_8046_1275"
                    x1="10.7893"
                    y1="9.0359"
                    x2="19.5616"
                    y2="36.5922"
            ...
            <div className="mb-8">
              <p className="text-[#E4E4E7] text-[14px] leading-[26px] font-normal max-w-[320px]">
                شرکت ما، زیرمجموعه‌ای از *شرکت اروین ویرا*، با تمرکز بر ارائه‌ی
                راهکارهای نوین و هوشمند، به بهبود مسیریابی و ارائه خدمات
                موقعیت‌یابی داخلی (Indoor Mapping) در فضاهای بزرگ و پیچیده
                می‌پردازد. هدف ما افزایش رضایت و راحتی کاربران در مکان‌های
                گسترده‌ای مانند بیمارستان‌ها، استادیوم‌ها، و مراکز تجاری است. با
                بهره‌گیری از تکنولوژی‌های پیشرفته، خدمات ما به مدیران مکان‌های
                عمومی امکان می‌دهد تجربه‌ای کاربرپسند، سریع و دقیق برای
                بازدیدکنندگان فراهم کنند.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                >
                  <path
                    d="M16.0317 0H15.9589C7.14503 0 0 7.14713 0 15.9636V16.0364C0 24.8529 7.14503 32 15.9589 32H16.0317C24.8455 32 31.9906 24.8529 31.9906 16.0364V15.9636C31.9906 7.14713 24.8455 0 16.0317 0Z"
                    fill="#52525B"
                    fillOpacity="0.1"
                  />
                  <path
                    d="M20.9454 6.51001H11.0466C8.31192 6.51001 6.08716 8.73542 6.08716 11.4709V20.5296C6.08716 23.2651 8.31192 25.4905 11.0466 25.4905H20.9454C23.6801 25.4905 25.9049 23.2651 25.9049 20.5296V11.4709C25.9049 8.73542 23.6801 6.51001 20.9454 6.51001ZM7.83671 11.4709C7.83671 9.7007 9.27691 8.26007 11.0466 8.26007H20.9454C22.7151 8.26007 24.1553 9.7007 24.1553 11.4709V20.5296C24.1553 22.2998 22.7151 23.7404 20.9454 23.7404H11.0466C9.27691 23.7404 7.83671 22.2998 7.83671 20.5296V11.4709Z"
                    fill="#A1A1AA"
                    className="transition-colors group-hover:fill-[#FB6514]"
                  />
                  <path
                    d="M15.996 20.6135C18.539 20.6135 20.6091 18.544 20.6091 15.999C20.6091 13.4541 18.5402 11.3845 15.996 11.3845C13.4518 11.3845 11.3828 13.4541 11.3828 15.999C11.3828 18.544 13.4518 20.6135 15.996 20.6135ZM15.996 13.1357C17.5752 13.1357 18.8596 14.4205 18.8596 16.0002C18.8596 17.5798 17.5752 18.8646 15.996 18.8646C14.4168 18.8646 13.1324 17.5798 13.1324 16.0002C13.1324 14.4205 14.4168 13.1357 15.996 13.1357Z"
                    fill="#A1A1AA"
                    className="transition-colors group-hover:fill-[#FB6514]"
                  />
                  <path
                    d="M21.0362 12.1302C21.721 12.1302 22.2791 11.573 22.2791 10.8869C22.2791 10.2008 21.7221 9.64355 21.0362 9.64355C20.3502 9.64355 19.7932 10.2008 19.7932 10.8869C19.7932 11.573 20.3502 12.1302 21.0362 12.1302Z"
                    fill="#A1A1AA"
                    className="transition-colors group-hover:fill-[#FB6514]"
                  />
                </svg>
              ...
              >
                ...
                >
                  <path
                    d="M16.0317 0H15.9589C7.14504 0 0 7.14713 0 15.9636V16.0364C0 24.8529 7.14504 32 15.9589 32H16.0317C24.8455 32 31.9906 24.8529 31.9906 16.0364V15.9636C31.9906 7.14713 24.8455 0 16.0317 0Z"
                    fill="#52525B"
                    fillOpacity="0.1"
                  />
                  <path
                    d="M7.62928 10.6361C7.20786 10.2449 6.99829 9.76054 6.99829 9.18429C6.99829 8.60804 7.20899 8.10241 7.62928 7.71002C8.0507 7.31875 8.59316 7.12256 9.25778 7.12256C9.92241 7.12256 10.4436 7.31875 10.8639 7.71002C11.2853 8.10129 11.4949 8.59346 11.4949 9.18429C11.4949 9.77512 11.2842 10.2449 10.8639 10.6361C10.4425 11.0274 9.90784 11.2236 9.25778 11.2236C8.60773 11.2236 8.0507 11.0274 7.62928 10.6361ZM11.1407 12.8806V24.8765H7.35133V12.8806H11.1407Z"
                    fill="#A1A1AA"
                    className="transition-colors group-hover:fill-[#FB6514]"
                  />
                  <path
                    d="M23.7551 14.0656C24.5811 14.9624 24.9936 16.1934 24.9936 17.7608V24.6646H21.3947V18.2473C21.3947 17.4569 21.1896 16.8426 20.7805 16.4053C20.3715 15.9681 19.82 15.7483 19.1296 15.7483C18.4392 15.7483 17.8878 15.967 17.4787 16.4053C17.0696 16.8426 16.8645 17.4569 16.8645 18.2473V24.6646H13.2444V12.8469H16.8645V14.4142C17.231 13.8918 17.7253 13.4792 18.3462 13.1754C18.9671 12.8716 19.6654 12.7202 20.4421 12.7202C21.8251 12.7202 22.9302 13.1687 23.7551 14.0644V14.0656Z"
                    fill="#A1A1AA"
                    className="transition-colors group-hover:fill-[#FB6514]"
                  />
                </svg>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li>
                    <Link
                      href="/articles"
                      className="text-gray-300 hover:text-[#FB6514] transition-colors text-sm"
                    >
                      اخبار و مقالات
                    </Link>
                  </li>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  <li>
                    <Link
                      href="/products/indoor-navigation"
                      className="text-gray-300 hover:text-[#FB6514] transition-colors text-sm"
                    >
                      ناوبری داخلی
                    </Link>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link
                      ...
                      className="text-gray-300 hover:text-[#FB6514] transition-colors text-sm block py-1"
                    >
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-300">
                  <li className="flex items-start gap-2">
                    ...
                    >
                      <path
                        d="M10 10.8333C12.3012 10.8333 14.1667 8.96785 14.1667 6.66667C14.1667 4.36548 12.3012 2.5 10 2.5C7.69881 2.5 5.83333 4.36548 5.83333 6.66667C5.83333 8.96785 7.69881 10.8333 10 10.8333Z"
                        stroke="#E4E4E7"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M2.5 17.5C2.5 14.1667 5.83333 11.6667 10 11.6667C14.1667 11.6667 17.5 14.1667 17.5 17.5"
                        stroke="#E4E4E7"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                      />
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    >
                      <path
                        d="M14.1667 17.0834H5.83341C3.33341 17.0834 1.66675 15.8334 1.66675 12.9167V7.08341C1.66675 4.16675 3.33341 2.91675 5.83341 2.91675H14.1667C16.6667 2.91675 18.3334 4.16675 18.3334 7.08341V12.9167C18.3334 15.8334 16.6667 17.0834 14.1667 17.0834Z"
                        stroke="#E4E4E7"
                        strokeWidth="1.25"
                        strokeMiterlimit="10"
                        strokeLinecap="round"
                    ...
                    <span className="text-sm">Arvinvira@Info.com</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <svg
                      width="20"
                    ...
                    <span className="text-sm">09129090990</span>
                  </li>
                </ul>
              </div>
            </div>
