...
export default function TechnologiesHero({ title, description }: TechnologiesHeroProps) {
  return (
    <section className="relative w-full flex justify-center items-center min-h-[372px] px-4 py-20">
