      ...
      default:
        return (
          ...
          >
            ...
            <path
              d="M16 8C11.6 8 8 11.6 8 16C8 20.4 11.6 24 16 24C20.4 24 24 20.4 24 16C24 11.6 20.4 8 16 8ZM19 17H17V19C17 19.6 16.6 20 16 20C15.4 20 15 19.6 15 19V17H13C12.4 17 12 16.6 12 16C12 15.4 12.4 15 13 15H15V13C15 12.4 15.4 12 16 12C16.6 12 17 12.4 17 13V15H19C19.6 15 20 15.4 20 16C20 16.6 19.6 17 19 17Z"
              fill="#A1A1AA"
            />
          </svg>
        );
...
const Footer = async () => {
  try {
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-16">
              ...
              <div className="flex gap-4">
                {socialLinks.length > 0 ? (
                  socialLinks.map((link, index) => (
                    <SocialIcon key={index} type={link.icon} url={link.url} />
                  ))
                ) : (
                  <>
                    <a
            ...
            <div className="lg:w-3/5">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                {/* رندر منوها */}
                {menuSections.map(
                  (section: FooterMenuSection, index: number) => (
                    <div key={index}>
    ...
    if (process.env.NODE_ENV === "development") {
      console.error("💥 Critical error loading footer:", error);
    }
        ...
        <div className="container mx-auto px-5 sm:px-8 lg:px-32 py-12">
          <div className="text-center py-8">
            <p className="text-gray-300">
              ⚠️ خطا در اتصال به سرور. لطفا دوباره تلاش کنید.
            </p>
